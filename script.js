...
console.log('Exercise 4 Result:', generateEmail("keya", "moradi.com"));
...
function greetUser(name, timeOfDay) {
    return `Good ${timeOfDay}, ${name}, I hope you're healthy and happy!`;
}

console.log('Exercise 5 Result:', greetUser("Keya", "morning"));
